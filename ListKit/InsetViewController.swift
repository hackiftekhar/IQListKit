...
extension InsetViewController {
    ...
    //            builder.append(IQTableViewCell.self, models: defaultCellItems, section: section1)
    //            builder.append(UserCell.self, models: users, section: section1)
    //            builder.append(BookCell.self, models: books, section: section1)
