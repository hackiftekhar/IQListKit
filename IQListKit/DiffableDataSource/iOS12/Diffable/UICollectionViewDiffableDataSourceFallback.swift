...
open class UICollectionViewDiffableDataSourceFallback<SectionIdentifierType: Hashable, ItemIdentifierType: Hashable>: NSObject, UICollectionViewDataSource {
    ...
    ///                 performing updates.
    public func apply(_ snapshot: NSDiffableDataSourceSnapshotFallback<SectionIdentifierType, ItemIdentifierType>, animatingDifferences: Bool = true, completion: (() -> Void)? = nil) {
        core.apply(
            snapshot,
            view: collectionView,
    ...
    ///
    /// - Returns: A new snapshot object of current state.
    public func snapshot() -> NSDiffableDataSourceSnapshotFallback<SectionIdentifierType, ItemIdentifierType> {
