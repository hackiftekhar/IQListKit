...
final class DiffableDataSourceCore<SectionIdentifierType: Hashable, ItemIdentifierType: Hashable> {
    ...
    private var currentSnapshot = NSDiffableDataSourceSnapshotFallback<SectionIdentifierType, ItemIdentifierType>()
    private var sections: [Section] = []

    func apply<View: AnyObject>(
        _ snapshot: NSDiffableDataSourceSnapshotFallback<SectionIdentifierType, ItemIdentifierType>,
        view: View?,
    ...
    func snapshot() -> NSDiffableDataSourceSnapshotFallback<SectionIdentifierType, ItemIdentifierType> {
        var snapshot = NSDiffableDataSourceSnapshotFallback<SectionIdentifierType, ItemIdentifierType>()
